  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Manage Categories</h2>
        <form (ngSubmit)="addCategory()" class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex flex-col">
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Name</label>
              <input type="text"
            ...
            <div class="flex flex-col">
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Color</label>
              <div class="relative">
                <div (click)="toggleNewColorDropdown()"
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span>{{newCategory.color || 'Select color'}}</span>
                  </div>
              ...
              <div class="relative">
                <div (click)="toggleEditColorDropdown()"
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span>{{editingCategory.color || 'Select color'}}</span>
                  </div>
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                  </svg>
