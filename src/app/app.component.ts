...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row max-w-full-screen">
      ...
      <ng-container *ngIf="!isLoginPage">
        ...
        <!-- Main content -->
        <div class="flex-grow md:ml-64 p-4 md:p-6 transition-all duration-300 overflow-x-hidden max-w-full">
